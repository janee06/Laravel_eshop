...
<div class="container mx-auto py-10">
    <h1 class="text-5xl font-semibold text-center mb-8 text-gray-900">Časté dotazy</h1>
    <div class="space-y-6">
        <!-- První dotaz -->
        <div>
            <button class="w-full text-left text-xl font-medium text-gray-900 bg-gray-200 px-6 py-4 rounded-lg flex justify-between items-center"
                    onclick="toggleAnswer(this)">
                Jak dlouho trvá zpracování mé žádosti?
                <span class="ml-4">+</span>
            </button>
            <div class="hidden mt-2 text-gray-800 px-6">
